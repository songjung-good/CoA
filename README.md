![로고](./docs/기타자료/logo48.webp) ![글자로고](./docs/기타자료/textLogo48.webp)
...
- 사용자는 초안을 바탕으로 간편하게 멋진 포트폴리오 완성 가능
  #Readme #자동화 #포트폴리오 #이걸로*나도*서류통과

2. 커밋 기반 종합 분석

- 과거 커밋 분석으로 프로젝트 내 기여 부분 자동 추출
- 코멘트 기능을 통해 강조하고 싶은 부분 직접 지정 가능 #커밋분석 #기능요약 #기술요약 #내가*뭐*했지? #내가*이런*걸!

3. 코딩 스타일 평가

- 성능, 가독성, 재사용성, 테스트 용이성, 예외처리 능력 종합 평가
- 사용자 개인의 강점과 보완점 파악 용이 #코드평가 #장점 #clean*code #나만의*도우미
...
- 자신의 위치 파악 및 성장 계획 수립에 활용
  #JAVA개발자 #JavaScript개발자 #개발자*통계 #나의*위치는?

## UCC

[![Video Label](./docs/기타자료/영상썸네일.jpg)](https://www.youtube.com/watch?v=TpPWlKMhlLo)
...
| 통계 & 마이페이지 <br> 데이터 시각화 <br> D3 library | 랜딩 & 상세페이지 <br> 반응형 / 인터렉티브 <br> 춘식이 전도사 | 메인 & 검색 <br> 컴포넌트 쪼개기 <br> Type만 하루종일 |
...
![ERD사진](./docs/기타자료/ERD.png)

### 아키텍쳐♟️

![아키텍쳐](./docs/기타자료/아키텍쳐.png)

### 폴더 구조

![프로젝트 구조](./docs/기타자료/프로젝트%20구조.jpg)

## 웹페이지

### 1. 랜딩페이지

![프로젝트 구조](./docs/사이트맵/00_로그인.gif)
...
![프로젝트 구조](./docs/사이트맵/04_메인페이지.gif)
...
![프로젝트 구조](./docs/사이트맵/COA-레포뷰%20상세조회.gif)

​ ✔️ Readme, 커밋분석, 레포점수 제공

​ ✔️ Readme 수정 및 저장, 다운로드 가능

 ✔️ 코드 줄 수 / 기여도 / 사용 언어 비율 제공 / 커밋 분석 제공
...
![프로젝트 구조](./docs/사이트맵/01_검색페이지.gif)
...
![프로젝트 구조](./docs/사이트맵/user_follow.jpg)
...
![프로젝트 구조](./docs/사이트맵/user_auth.jpg)
...
![프로젝트 구조](./docs/사이트맵/05_마이페이지.gif)

| 데이터시각화                                             |                                                       |
| -------------------------------------------------------- | ----------------------------------------------------- |
| ![BarChartRace](./docs/사이트맵/chart/BarChartRace.gif)  | ![프로젝트 구조](./docs/사이트맵/chart/연혁차트.webp) |
| ![심층분석차트](./docs/사이트맵/chart/심층분석차트.webp) | ![레포카드](./docs/사이트맵/chart/레포카드.webp)      |
...
### 회고
    ...
    - 구본웅
        - 프로젝트를 시작할 때 기획은 멋진데 아무도 AI를 할 수 없는 상황이 없어 곤란했음
        - AI와 프롬프트 엔지니어링은 결코 쉬운 일이 아닌 것 같다.
        - 많은 시행착오를 겪은 만큼 생성형 AI를 다루는 데에 많이 배울 수 있었고, 다음 프로젝트는 좀 더 완성도 있는 결과를 내고 싶다.
